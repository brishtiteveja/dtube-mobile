                          ...
                          child: OutlineButton(
                            ...
                            onPressed: () async {
                              ...
                              if (Platform.isAndroid) {
                                launchUrl("https://steemconnect.com/oauth2/authorize?client_id=dtubeviewer&redirect_uri=dtubeapp://d.tube&scope=",
                                    context);
                              } else {
                                launchUrl(
                                    "https://steemconnect.com/oauth2/authorize?client_id=dtubeviewer&redirect_uri=https://dtubeviewer.firebaseapp.com&scope=",
                                    context);
                              }
                            },
                          ),
