...
class HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: design
          ? new FutureBuilder(
              //future: null, //steemit.getAll(user), // a Future<String> or null
...
//                    }
                      ...
                      body: SingleChildScrollView(
                        child: Column(
                          children: <Widget>[
                            ...
                            new Container(
                                height: 210.0,
                                color: Colors.green,//theme(selectedTheme)["background"],
          ...
          : new FutureBuilder(
              //future: null, //steemit.getDiscussionsByHot(), // a Future<String> or null
        ...
        title: Stack(
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                Switch(
                  activeColor: Colors.green,//theme(selectedTheme)["primary"],
                  value: design,
                  onChanged: (e) {
                    setState(() {
                      design = e;
